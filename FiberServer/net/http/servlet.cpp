...
int32_t FunctionServlet::handle(FiberServer::http::HttpRequest::ptr request
               , FiberServer::http::HttpResponse::ptr response
               , FiberServer::http::HttpSession::ptr session) {
...
int32_t ServletDispatch::handle(FiberServer::http::HttpRequest::ptr request
               , FiberServer::http::HttpResponse::ptr response
               , FiberServer::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(FiberServer::http::HttpRequest::ptr request
                   , FiberServer::http::HttpResponse::ptr response
                   , FiberServer::http::HttpSession::ptr session) {
    response->setStatus(FiberServer::http::HttpStatus::NOT_FOUND);
